...
import { Accordion, AccordionDetails, AccordionSummary, Chip, List, ListItemButton, ListItemText, Paper } from '@mui/material'
import React, { useState } from 'react'
import { useSelector } from 'react-redux';

export const Agendar_Comp1_Servicios = ({onSeleccionServicio}) => {
    //selectors
    ...
    let servicio_No_agendado = (personaIndex, servicioid) => {
     ...
     //funcion props seleccionar-servicio
      const onSeleccionarServicio = ({ servicioid, serviciominutos, descripcion }, personaIndex) => {
        onSeleccionServicio({servicioid: servicioid,serviciominutos, descripcion,personaIndex});
      }
